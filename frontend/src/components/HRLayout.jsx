    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#F0F2F5' }}>
      <aside style={{
        ...
        <div style={{ padding: '28px 24px 20px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          <div style={{ fontSize: 20, fontWeight: 800, color: '#fff', letterSpacing: '-0.5px' }}>EcoFinTec</div>
          <div style={{
            display: 'inline-block', marginTop: 6,
            background: 'rgba(13,115,119,0.25)', border: '1px solid rgba(13,115,119,0.5)',
            borderRadius: 6, padding: '2px 10px', fontSize: 10, fontWeight: 700,
            color: '#5eead4', letterSpacing: 1.5, textTransform: 'uppercase',
          }}>
            HR Module
          </div>
        </div>
      ...
      <div style={{ marginLeft: 240, flex: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        <header style={{
          ...
          <span style={{ fontSize: 13, color: '#888' }}>HR Module</span>
          <span style={{ marginLeft: 'auto', fontSize: 13, color: '#555', fontWeight: 600 }}>{user?.full_name}</span>
        </header>
