...
SECRET_KEY = os.environ.get("SECRET_KEY", "pentad-crm-secret-key-change-in-production")
ALGORITHM = "HS256"
...
def require_admin_or_team_leader(current_user: User = Depends(get_current_user)) -> User:
